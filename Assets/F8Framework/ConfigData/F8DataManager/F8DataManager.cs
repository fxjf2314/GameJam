...
namespace F8Framework.F8ExcelDataClass
{
	public class F8DataManager : ModuleSingleton<F8DataManager>, IModule
	{
		...
		[Preserve]
		public ItemTypeItem GetItemTypeByID(int id)
		{
			ItemTypeItem t = null;
			p_ItemType.Dict.TryGetValue(id, out t);
			if (t == null) LogF8.LogError("找不到id： " + id + " ，配置表： ItemType");
			return t;
		}

		[Preserve]
		public Dictionary<int, ItemTypeItem> GetItemType()
		{
			return p_ItemType.Dict;
		}
		...
		public void LoadAll()
		{
			...
			p_ItemType = Load<ItemType>("ItemType") as ItemType;
			p_LocalizedStrings = Load<LocalizedStrings>("LocalizedStrings") as LocalizedStrings;
		}
		...
		public void RuntimeLoadAll(Dictionary<String, System.Object> objs)
		{
			...
			p_ItemType = objs["ItemType"] as ItemType;
		...
		public IEnumerable LoadAllAsync()
		{
			...
			yield return LoadAsync<ItemType>("ItemType", result => p_ItemType = result as ItemType);
			yield return LoadAsync<LocalizedStrings>("LocalizedStrings", result => p_LocalizedStrings = result as LocalizedStrings);
		}
